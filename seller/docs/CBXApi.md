...
import time
import crossly
from crossly.api import cbx_api
...
with crossly.ApiClient(configuration) as api_client:
    ...
    api_instance = cbx_api.CBXApi(api_client)

    # example, this endpoint has no required or optional parameters
    try:
        # Record cashback a user earned, in cents.
        api_response = api_instance.create_cbx_accrual()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_accrual: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Accrue cashback for an order at the resolved rate.
        api_response = api_instance.create_cbx_accrual_purchase()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_accrual_purchase: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cbx_api.CBXApi(api_client)
    accrual_id = "accrualId_example" # str | 

    # example passing only required values which don't have defaults set
    try:
        # Claw back a pending accrual — a refund, a cancellation, fraud.
        api_response = api_instance.create_cbx_accrual_reverse(accrual_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_accrual_reverse: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Claim ad credit against a CBX transfer you sent.
        api_response = api_instance.create_cbx_ad_credit_purchase()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_ad_credit_purchase: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # What a given number of tokens buys in ad credit.
        api_response = api_instance.create_cbx_ad_credit_quote()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_ad_credit_quote: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Consume credit for a billing period.
        api_response = api_instance.create_cbx_ad_credit_spend()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_ad_credit_spend: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Fund elevated cashback on matching items.
        api_response = api_instance.create_cbx_boost()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_boost: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cbx_api.CBXApi(api_client)
    boost_id = "boostId_example" # str | 

    # example passing only required values which don't have defaults set
    try:
        # Stop a boost from matching further orders.
        api_response = api_instance.create_cbx_boost_pause(boost_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_boost_pause: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a campaign in draft.
        api_response = api_instance.create_cbx_campaign()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_campaign: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cbx_api.CBXApi(api_client)
    campaign_id = "campaignId_example" # str | 

    # example passing only required values which don't have defaults set
    try:
        # Approve the previewed recipient list.
        api_response = api_instance.create_cbx_campaign_approve(campaign_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_campaign_approve: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Pay an approved campaign.
        api_response = api_instance.create_cbx_campaign_execute(campaign_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_campaign_execute: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Compute the recipient list without paying it.
        api_response = api_instance.create_cbx_campaign_preview(campaign_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_campaign_preview: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Reserve a claim. Debits the balance and queues the transfer.
        api_response = api_instance.create_cbx_claim()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_claim: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # What a claim would cost, without committing to it.
        api_response = api_instance.create_cbx_claim_quote()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_claim_quote: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cbx_api.CBXApi(api_client)
    claim_id = "claimId_example" # str | 

    # example passing only required values which don't have defaults set
    try:
        # Send a reserved claim on chain.
        api_response = api_instance.create_cbx_claim_send(claim_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_claim_send: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Draw against a line, receiving grant credit.
        api_response = api_instance.create_cbx_credit_draw()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_credit_draw: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Stop new draws. Leaves the drawn balance on its terms.
        api_response = api_instance.create_cbx_credit_freeze()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_credit_freeze: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Recompute a limit from trading history and stake.
        api_response = api_instance.create_cbx_credit_refresh()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_credit_refresh: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Apply a repayment to a line.
        api_response = api_instance.create_cbx_credit_repay()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_credit_repay: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Fire a distribution when the events pool crosses a threshold.
        api_response = api_instance.create_cbx_disbursement_rule()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_disbursement_rule: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Enable or disable a rule.
        api_response = api_instance.create_cbx_disbursement_rule_active(rule_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_disbursement_rule_active: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Evaluate a rule now. Fires it if every gate passes.
        api_response = api_instance.create_cbx_disbursement_rule_check(rule_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_disbursement_rule_check: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Define an earn term.
        api_response = api_instance.create_cbx_earn_tier()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_earn_tier: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # What would this order earn, and why.
        api_response = api_instance.create_cbx_rate_quote()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_rate_quote: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Pay for a service in CBX.
        api_response = api_instance.create_cbx_redemption()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_redemption: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # What a service costs in tokens right now.
        api_response = api_instance.create_cbx_redemption_quote()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_redemption_quote: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Move accrued revenue from the reserve to your revenue wallet.
        api_response = api_instance.create_cbx_revenue_sweep()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_revenue_sweep: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Redeem a user's CBX against an order.
        api_response = api_instance.create_cbx_spend()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_spend: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Refund a spend — give the tokens back and claw the skim back.
        api_response = api_instance.create_cbx_spend_reverse(external_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_spend_reverse: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Define a staking tier.
        api_response = api_instance.create_cbx_stake_tier()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_stake_tier: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Map one of your user ids to a CBX subject.
        api_response = api_instance.create_cbx_subject()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_subject: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cbx_api.CBXApi(api_client)
    subject_id = "subjectId_example" # str | 

    # example passing only required values which don't have defaults set
    try:
        # Issue grant credit — in-platform, non-withdrawable.
        api_response = api_instance.create_cbx_subject_grant(subject_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_subject_grant: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Which balances would pay for a spend, and in what order.
        api_response = api_instance.create_cbx_subject_spend_plan(subject_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_subject_spend_plan: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Lock a subject's tokens for a tier.
        api_response = api_instance.create_cbx_subject_stake(subject_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_subject_stake: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Start the cooldown. Tokens unlock when it elapses.
        api_response = api_instance.create_cbx_subject_stake_unstake(subject_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_subject_stake_unstake: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Start wallet verification. Returns a message for the user to sign.
        api_response = api_instance.create_cbx_wallet_challenge()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_wallet_challenge: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Present the signature. Returns a ship / do-not-ship decision.
        api_response = api_instance.create_cbx_wallet_payment_confirm()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_wallet_payment_confirm: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Build a transfer for the buyer to sign themselves.
        api_response = api_instance.create_cbx_wallet_payment_quote()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_wallet_payment_quote: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # A human decides on a held payment.
        api_response = api_instance.create_cbx_wallet_payment_resolve(payment_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_wallet_payment_resolve: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Complete wallet verification with the user's signature.
        api_response = api_instance.create_cbx_wallet_verify()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->create_cbx_wallet_verify: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Unspent advertising credit, in cents.
        api_response = api_instance.get_cbx_ad_credit()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->get_cbx_ad_credit: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # A claim's current state.
        api_response = api_instance.get_cbx_claim(claim_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->get_cbx_claim: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # A seller's wholesale credit line.
        api_response = api_instance.get_cbx_credit()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->get_cbx_credit: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Identity check — which merchant this key belongs to, and its terms.
        api_response = api_instance.get_cbx_me()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->get_cbx_me: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Your events-pool balance.
        api_response = api_instance.get_cbx_pool()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->get_cbx_pool: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Operator revenue accrued and not yet withdrawn.
        api_response = api_instance.get_cbx_revenue()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->get_cbx_revenue: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # What a subject holds: pending cents and available CBX.
        api_response = api_instance.get_cbx_subject_balance(subject_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->get_cbx_subject_balance: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # All three balances a subject holds.
        api_response = api_instance.get_cbx_subject_balance_by_subject_id(subject_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->get_cbx_subject_balance_by_subject_id: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Total CBX a subject has spent in your marketplace.
        api_response = api_instance.get_cbx_subject_spent(subject_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->get_cbx_subject_spent: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # A subject's staking state and spendable balance.
        api_response = api_instance.get_cbx_subject_stake(subject_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->get_cbx_subject_stake: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # The verified payout address for a subject, if any.
        api_response = api_instance.get_cbx_subject_wallet(subject_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->get_cbx_subject_wallet: %s\n" % e)
```
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Your most recent reserve reconciliation.
        api_response = api_instance.get_cbx_treasury()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->get_cbx_treasury: %s\n" % e)
```
...
> bool, date, datetime, dict, float, int, list, str, none_type list_cbx_ad_credit_ledger()
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Ad-credit movements, newest first.
        api_response = api_instance.list_cbx_ad_credit_ledger()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->list_cbx_ad_credit_ledger: %s\n" % e)
```
...
# **list_cbx_boosts**
> bool, date, datetime, dict, float, int, list, str, none_type list_cbx_boosts()
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Your funded cashback boosts, newest first.
        api_response = api_instance.list_cbx_boosts()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->list_cbx_boosts: %s\n" % e)
```
...
> bool, date, datetime, dict, float, int, list, str, none_type list_cbx_campaign_payouts(campaign_id)
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # What a campaign actually paid, with the weight behind each amount.
        api_response = api_instance.list_cbx_campaign_payouts(campaign_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->list_cbx_campaign_payouts: %s\n" % e)
```
...
# **list_cbx_campaigns**
> bool, date, datetime, dict, float, int, list, str, none_type list_cbx_campaigns()
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Your campaigns, newest first.
        api_response = api_instance.list_cbx_campaigns()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->list_cbx_campaigns: %s\n" % e)
```
...
> bool, date, datetime, dict, float, int, list, str, none_type list_cbx_disbursement_progress()
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # How close each rule is to firing — the public counter.
        api_response = api_instance.list_cbx_disbursement_progress()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->list_cbx_disbursement_progress: %s\n" % e)
```
...
> bool, date, datetime, dict, float, int, list, str, none_type list_cbx_disbursement_rules()
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Threshold rules that fire community distributions.
        api_response = api_instance.list_cbx_disbursement_rules()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->list_cbx_disbursement_rules: %s\n" % e)
```
...
# **list_cbx_earn_tiers**
> bool, date, datetime, dict, float, int, list, str, none_type list_cbx_earn_tiers()
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Earn terms on offer — longer maturation, higher rate.
        api_response = api_instance.list_cbx_earn_tiers()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->list_cbx_earn_tiers: %s\n" % e)
```
...
> bool, date, datetime, dict, float, int, list, str, none_type list_cbx_redemption_services()
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Services payable in CBX, and the discount each carries.
        api_response = api_instance.list_cbx_redemption_services()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->list_cbx_redemption_services: %s\n" % e)
```
...
> bool, date, datetime, dict, float, int, list, str, none_type list_cbx_stake_tiers()
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Staking tiers — what locking tokens buys.
        api_response = api_instance.list_cbx_stake_tiers()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->list_cbx_stake_tiers: %s\n" % e)
```
...
> bool, date, datetime, dict, float, int, list, str, none_type list_cbx_subject_grants(subject_id)
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Live grants, soonest-expiring first.
        api_response = api_instance.list_cbx_subject_grants(subject_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->list_cbx_subject_grants: %s\n" % e)
```
...
> bool, date, datetime, dict, float, int, list, str, none_type list_cbx_subject_ledger(subject_id)
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # A subject's CBX ledger, newest first.
        api_response = api_instance.list_cbx_subject_ledger(subject_id)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->list_cbx_subject_ledger: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        # A subject's CBX ledger, newest first.
        api_response = api_instance.list_cbx_subject_ledger(subject_id, limit=limit)
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->list_cbx_subject_ledger: %s\n" % e)
```
...
> bool, date, datetime, dict, float, int, list, str, none_type list_cbx_wallet_payment_review()
...
with crossly.ApiClient(configuration) as api_client:
    ...
    try:
        # Payments held for a human — the ops queue.
        api_response = api_instance.list_cbx_wallet_payment_review()
        pprint(api_response)
    except crossly.ApiException as e:
        print("Exception when calling CBXApi->list_cbx_wallet_payment_review: %s\n" % e)
```
