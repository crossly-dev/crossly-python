...
------------ | ------------- | ------------- | -------------
**platform_listings** | [**[GetListingResponsePlatformListings]**](GetListingResponsePlatformListings.md) |  | 
**id** | **str** |  | 
**created_at** | **datetime** |  | 
**updated_at** | **datetime** |  | 
**user_id** | **str** |  | 
...
**video_url** | **str, none_type** |  | [optional] 
**price_floor_cents** | **float, none_type** |  | [optional] 
...
**grade_key** | **str, none_type** |  | [optional] 
**grading** | [**ListListingsItemGrading**](ListListingsItemGrading.md) |  | [optional] 
**publish_at** | **datetime, none_type** |  | [optional] 
**scheduled_platforms** | **[str], none_type** |  | [optional] 
**parent_listing_id** | **str, none_type** |  | [optional] 
**hs_code** | **str, none_type** |  | [optional] 
**country_of_origin** | **str, none_type** |  | [optional] 
**delisted_at** | **datetime, none_type** |  | [optional] 
**sold_at** | **datetime, none_type** |  | [optional] 
**duplicate_of_listing_id** | **str, none_type** |  | [optional] 
**client_draft_id** | **str, none_type** |  | [optional] 
